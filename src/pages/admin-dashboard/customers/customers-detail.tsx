...
export function AdminDashboardCustomersDetails() {
  ...
  const customerName = () => {
    ...
    return !firstName ? "Unnamed Customer" : customerName;
  };
  ...
  const BreadCrumb = () => (
    <div className="font-inter font-light capitalize flex items-center">
      ...
      <Link className="text-primary-900" to="/admin-dashboard/customers/">
        Customers
      </Link>
                ...
                <div className="flex justify-between items-center">
                  <div className="max-w-[386px]">
                    ...
                    <p className="text-[#4F4F4F] text-sm mt-3">
                      Deleting this account will permanently remove the
                      customer’s information. This action cannot be undone.
                    </p>
                  </div>
                  <button
